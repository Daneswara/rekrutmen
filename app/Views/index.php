...
<?php $this->include('/section/browse') ?>

<?php $this->include('/section/hiring') ?>
<?= $this->include('/section/job_list') ?>
<?php $this->include('/section/find_job') ?>
<?php $this->include('/section/total_rekruit') ?>
<?php $this->include('/section/top_rekruiter') ?>
<?php $this->include('/section/jobs_location') ?>
<?php $this->include('/section/news_blog') ?>
<?php $this->include('/section/send_email') ?>
